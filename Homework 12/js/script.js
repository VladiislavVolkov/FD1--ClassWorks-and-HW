...
// определение полв с использованием условной операции
    // sex == true ? sex = "мужской" : sex = "женский";

let pension; 
// опред. пенсия с использ. условного оператора ВАРИАНТ 1
    // if (sex == `мужской` ) {
    //     if (years >= 63) {
    //         pension = ("да");
    //     } else {
